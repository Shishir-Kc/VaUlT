...
import { Eye, EyeOff, Lock, User, Mail, HelpCircle, Loader2 } from 'lucide-react';
            ...
            <main className="flex-1 flex items-center justify-center p-4 z-10">
                <div className="w-full max-w-md bg-[#1a2c24] rounded-3xl p-8 shadow-2xl border border-white/5 backdrop-blur-sm">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 text-sm">Join VaUlT to secure your digital life.</p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSignup}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-300 text-black font-bold py-3.5 rounded-xl shadow-lg shadow-green-500/20 transform transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed mt-2"
                        >
                            {loading ? (
                    ...
                    <div className="mt-8 text-center space-y-6">
                        <p className="text-sm text-gray-400">
                            ...
                            <button onClick={() => navigate('/login')} className="text-green-500 font-bold hover:text-green-400 transition-colors">
                                Log In
                            </button>
                        </p>
